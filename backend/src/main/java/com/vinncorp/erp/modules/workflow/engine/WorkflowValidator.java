...
import com.vinncorp.erp.modules.workflow.repository.WorkflowTransitionRuleRepository;
...
public class WorkflowValidator {
    ...
    public void validate(Task task, Long fromStatusId, Long toStatusId, String email) {
        ...
        boolean transitionExists = transitionRepository.existsByProjectIdAndFromStatusIdAndToStatusId(
    ...
    private void validateNoIncompleteSubtasks(Long taskId) {
        ...
        WorkflowStatus doneStatus = workflowStatusRepository
                .findByProjectIdAndName(task.getProject().getId(), "DONE")
                .orElse(null);
        if (doneStatus != null) {
