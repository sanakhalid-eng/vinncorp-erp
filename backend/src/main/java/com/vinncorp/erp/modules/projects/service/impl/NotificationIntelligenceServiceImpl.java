...
import com.vinncorp.erp.modules.projects.dto.response.NotificationIntelligenceResponse;
...
public class NotificationIntelligenceServiceImpl implements NotificationIntelligenceService {
    ...
    public NotificationIntelligenceResponse getIntelligence(Long userId) {
        ...
        return NotificationIntelligenceResponse.builder()
                .unreadCount(unread)
                .categoryBreakdown(breakdown)
                .suggestedActions(suggested)
                .digestRecommended(digestRecommended)
                .build();
    }
}
