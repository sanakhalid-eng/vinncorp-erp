...
@Index(name = "idx_wf_logs_rule", columnList = "rule_id"), @Index(name = "idx_wf_logs_status", columnList = "status"), @Index(name = "idx_wf_logs_entity", columnList = "entity_type, entity_id"), @Index(name = "idx_wf_logs_created", columnList = "created_at")}) @Getter
@Setter
...
@Column(name = "execution_time_ms", nullable = false) private long executionTimeMs;
