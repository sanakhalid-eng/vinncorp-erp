...
NotificationResponse createNotification(Long userId, Long senderId, NotificationType type, String message, Long entityId, String entityType, Long projectId, String projectName, String actionUrl);
NotificationResponse createNotification(Long userId, Long senderId, NotificationType type, String message, Long entityId, String entityType, Long projectId, String projectName, String actionUrl, String eventId, String groupKey, String priority);
