        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="animate-pulse bg-white dark:bg-surface-800 rounded-2xl h-64 shadow-sm ring-1 ring-surface-200 dark:ring-surface-700"
              />
            ))} 
          </div>
          ...
          <div className="text-center py-24 bg-white dark:bg-surface-800 rounded-2xl shadow-sm ring-1 ring-surface-200 dark:ring-surface-700">
             
            <FolderOpen className="w-16 h-16 mx-auto text-surface-300 dark:text-surface-600 mb-4" /> 
            <h3 className="text-xl font-bold text-surface-700 dark:text-surface-200 mb-2">
              No projects found
            </h3> 
