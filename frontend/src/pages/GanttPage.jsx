...
export default function GanttPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] flex-col bg-white dark:bg-surface-950">
      <div className="flex items-center justify-between border-b border-surface-200 dark:border-surface-800 px-4 py-2">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-white/80 dark:bg-surface-950/80">
          <div className="text-center text-surface-500">
            ...
            <p className="text-sm mt-1">
              Add start and end dates to tasks to see them on the Gantt chart
            </p>
          </div>
        </div>
      )}
