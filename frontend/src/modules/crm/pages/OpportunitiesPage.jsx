...
export default function OpportunitiesPage() {
  ...
  const handleWon = async (id) => {
    if (!window.confirm("Mark this deal as WON? This will create a project.")) return;
    try {
  ...
  const handleLost = async (id) => {
    if (!window.confirm("Mark this deal as LOST?")) return;
    try {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      {loading ? (
        ...
        <div className="py-20 text-center text-slate-400">No opportunities found</div>
      ) : (
