...
export default function MyProfilePage() {
  ...
  if (error) {
    return <ErrorState title="Failed to load profile" message={error} onRetry={loadProfile} />;
  }

  if (!employee) {
    return <EmptyState title="No employee profile found" message="Please contact HR to set up your employee profile." />;
  }
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.workEmail || 'ΓÇö'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                <Mail className="w-5 h-5 text-slate-400" />
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.personalEmail || 'ΓÇö'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.phone || 'ΓÇö'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.dateOfBirth || 'ΓÇö'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.timezone || 'ΓÇö'}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.departmentId || 'ΓÇö'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                <Briefcase className="w-5 h-5 text-slate-400" />
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.designationId || 'ΓÇö'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                <Calendar className="w-5 h-5 text-slate-400" />
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.hireDate || 'ΓÇö'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                <User className="w-5 h-5 text-slate-400" />
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.managerId || 'ΓÇö'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50">
                <Calendar className="w-5 h-5 text-slate-400" />
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-900">{employee.terminationDate || 'ΓÇö'}</p>
                </div>
              </div>
            </div>
          </div>
