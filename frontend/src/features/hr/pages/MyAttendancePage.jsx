...
export default function MyAttendancePage() {
  ...
  if (error) {
    return <ErrorState title="Failed to load attendance" message={error} onRetry={loadData} />;
  }
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      {attendance.length === 0 ? (
        <EmptyState title="No attendance records" message="No records found for this period." />
      ) : (
              ...
              {attendance.map((a) => (
                <tr key={a.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-4 py-3 text-slate-700">
                    {a.checkInTime ? new Date(a.checkInTime).toLocaleTimeString() : 'ΓÇö'}
                  </td>
                  <td className="px-4 py-3 text-slate-700">
                    {a.checkOutTime ? new Date(a.checkOutTime).toLocaleTimeString() : 'ΓÇö'}
                  </td>
