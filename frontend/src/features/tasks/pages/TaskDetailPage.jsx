...
export default function TaskDetailPage() {
  ...
  const formatDate = (d) => (d ? new Date(d).toLocaleDateString() : "ΓÇö");
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8 p-4 rounded-2xl bg-gray-50 border border-gray-100">
        ...
        <div>
          ...
          <p className="text-sm font-medium text-gray-900">{task.storyPoints ?? "ΓÇö"}</p>
        </div>
        <div>
          <p className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">
          ...
          <p className="text-sm font-medium text-gray-900">
            {task.createdBy?.name || task.createdBy?.username || "ΓÇö"}
          </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm text-gray-800">
                  {task.startDate ? formatDate(task.startDate) : "ΓÇö"} ΓåÆ{" "}
                  {task.endDate ? formatDate(task.endDate) : "ΓÇö"}
                </p>
              </div>
              {task.project && (
                <div>
