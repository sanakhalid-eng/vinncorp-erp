...
import { getSprints } from "../../sprints/api/sprintApi";
...
const CalendarPage = () => {
  ...
  const loadCalendarData = async () => {
    ...
    try {
      ...
      setError(error.response?.data?.message || "Failed to load calendar data");
  ...
  if (error) {
    return (
      <>
        <Toaster position="top-right" />
        <ErrorState title="Failed to load calendar" message={error} onRetry={loadCalendarData} />
      </>
    );
  }
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        {!calendarData && (
          <EmptyState
            ...
            description="Select a project to view calendar"
          />
        )}
